...
function sol = L1SudokuSolving(orginClues, guesses, iterCount, solution)
    ...
    if(iterCount >= iterationThresh)
        ...
        checkedBackwards = checkBackwards(sizeOfPuzzle, holder, orginClues, solution);
        ...
        checkedRL = checkRightLeft(sizeOfPuzzle, checkedBackwards, orginClues, solution);
        ...
        checkedLR = checkLeftRight(sizeOfPuzzle, checkedRL, orginClues, solution);
        ...
        sol = L1SudokuSolving(orginClues, checkedLR, iterCount, solution);
    end
end


function done = checkBackwards(sizeOfPuzzle, clues ,oriClues, solution)
    ...
    A =  makingA(sizeOfPuzzle, rawClues);
    b = ones(size(A,1),1);
    m = size(A,1);
    n = size(A,2);
    cvx_begin
...
function done = checkLeftRight(sizeOfPuzzle, clues ,oriClues, solution)
...
function done = checkRightLeft(sizeOfPuzzle, clues ,oriClues, solution)
...
function A = makingA(sizeOfPuzzle, clues)
    clues = arrangeClues(clues);
